        ...
        return {
          ...
          prospects:
            data.prospects?.map((prospect: any) => ({
              ...
              taille_entreprise: prospect.size || "Non spécifiée", // Ensure these are mapped
              volume_pieces_estime: prospect.volume_pieces_estime || "Non spécifié", // Ensure these are mapped
              zone_geographique: prospect.zone_geographique || "Non spécifiée", // Ensure these are mapped
            })) || [],
        }
      case "contacts": // Added explicit handling for contacts search type
        return {
          ...baseResponse,
          contacts:
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <header className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">🎯 Prospection IA - CGR International</h1>
          <p className="text-gray-600">Trouvez des prospects qualifiés automatiquement avec l'IA</p>
        </header>
